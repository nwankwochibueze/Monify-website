// src/components/MeetOurExperts.jsx
    ...
    <main className="bg-green-200 pt-10 pb-10">
      <div className="p-6 md:p-12 lg:p-16">
        <motion.div className="overflow-hidden" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.5 }} variants={textRevealVariant}>
          {/* ADDED font-heading */}
          <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold text-slate-900 mb-12 tracking-tight text-center font-heading">
            Meet our experts
          </h2>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-center md:items-start">
            <div className="w-full max-w-xs h-72 md:h-80 lg:h-96 relative mb-6 overflow-hidden">
              <img src={Fintech6} alt="monify image" className="w-full h-full object-cover object-center" />
            </div>
            <div className="w-full max-w-xs text-center md:text-left">
              <motion.div className="overflow-hidden" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.5 }} variants={textRevealVariant}>
                {/* ADDED font-heading */}
                <h3 className="text-xl md:text-2xl font-semibold text-slate-900 tracking-tight mb-4 font-heading">
                  Joan Davis
                </h3>
              </motion.div>
              <motion.div className="overflow-hidden" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.5 }} variants={paragraphVariant}>
                {/* ADDED font-sans */}
                <p className="text-sm md:text-base text-slate-900 font-sans">
          ...
          <div className="flex flex-col items-center md:items-start">
            <div className="w-full max-w-xs h-72 md:h-80 lg:h-96 relative mb-6 overflow-hidden">
              <img src={Fintech8} alt="Business consultant" className="w-full h-full object-cover object-center" />
            </div>
            <div className="w-full max-w-xs text-center md:text-left">
              <motion.div className="overflow-hidden" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.5 }} variants={textRevealVariant}>
                {/* ADDED font-heading */}
          ...
          <div className="flex flex-col items-center md:items-start">
            <div className="w-full max-w-xs h-72 md:h-80 lg:h-96 relative mb-6 overflow-hidden">
              <img src={Fintech7} alt="Legal advisor" className="w-full h-full object-cover object-center" />
            </div>
            <div className="w-full max-w-xs text-center md:text-left">
              <motion.div className="overflow-hidden" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.5 }} variants={textRevealVariant}>
                {/* ADDED font-heading */}
